...
public class RegisterActivity extends AppCompatActivity {
    ...
    private String userName,phone, psw, pswAgain;
            ...
            public void onClick(View v) {
                ...
                new Thread(){public void run() {
                    ...
                    try {
                        ...
                        //准备要发送的数据
                        String data = "use_name=" + URLEncoder.encode(userName, "utf-8") + "&password=" + URLEncoder.encode(psw, "utf-8") + "&use_account=" + URLEncoder.encode(phone, "utf-8");
    ...
    private void savedRegisterToken(String userName,String psw){
